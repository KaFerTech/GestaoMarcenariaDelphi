inherited frmOrcamento: TfrmOrcamento
  ...
  object gbU6: TGroupBox [3]
    ...
    Caption = 'Cliente'
    TabOrder = 3
    object cboClienteOS: TDBLookupComboBox
      Left = 3
      Top = 16
      Width = 273
      Height = 21
  ...
  object GroupBox4: TGroupBox [9]
    ...
    Caption = 'Telefone'
    TabOrder = 9
    object edtTelefoneContato: TDBEdit
      Left = 3
      Top = 16
      Width = 128
      Height = 21
  ...
  object PageControl1: TPageControl [10]
    ...
    object tbsProdutos: TTabSheet
      ...
      object GroupBox6: TGroupBox
        ...
        TabOrder = 2
        object edtComplementoProduto: TDBEdit
          Left = 3
          Top = 16
          Width = 234
          Height = 21
      ...
      object GroupBox7: TGroupBox
        ...
        Caption = 'Largura'
        TabOrder = 3
        object edtLarguraProduto: TDBEdit
          Left = 3
          Top = 15
          Width = 70
          Height = 21
      ...
      object GroupBox8: TGroupBox
        ...
        Caption = 'Altura'
        TabOrder = 4
        object edtAlturaProduto: TDBEdit
          Left = 3
          Top = 15
          Width = 70
          Height = 21
      ...
      object GroupBox13: TGroupBox
        ...
        TabOrder = 9
        object edtProfundidadeProduto: TDBEdit
          Left = 3
          Top = 15
          Width = 70
          Height = 21
  ...
  object GroupBox10: TGroupBox [11]
    ...
    Width = 201
    Height = 42
    Caption = 'Funcionario Responsavel'
    TabOrder = 11
  ...
  object dsMaterialProduto: TDataSource
    Left = 936
    Top = 344
  end
  ...
  object dsOutrosMateriais: TDataSource
    Left = 936
    Top = 296
  end
